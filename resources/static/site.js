...
class MainClass {
    ...
    PostJson(url, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.cancelToken = axios_1.default.CancelToken.source();
            try {
                const { data } = yield axios_1.default.post(url, JSON.stringify(payload), { headers: { 'Content-Type': 'application/json' } });
    ...
    ParseUpdateData(items) {
        console.error('parse', items);
        items.forEach(item => {
            valueinfo_1.UpdateValueElement(this.someRange, item.info);
        });
    }
    ;
    RegularUpdate() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { data } = yield axios_1.default.get(`/${this.i}/settings`, { cancelToken: this.cancelToken.token });
...
window.addEventListener('load', () => {
    const cameraIndex = parseInt(urlparam_1.URLParam('index') || '0');
...
},{"./urlparam":2,"./valueinfo":3,"axios":4}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
function UpdateValueElement(elem, valueInfo) {
    if (!elem) {
        return;
    }
...
exports.UpdateValueElement = UpdateValueElement;
